...
export OUTNAME=pvzge-app-anylinux-"$ARCH".AppImage
export DESKTOP=/usr/share/applications/pvzge-app.desktop
export ICON=/usr/share/icons/hicolor/512x512/apps/pvzge-app.png
export OUTPATH=./dist
...
# Point to binaries
./quick-sharun /usr/bin/pvzge-app
